...
function Header() {
  return <header className="site-header"><div className="nav-shell">
    <a className="brand" href="#top" aria-label="FloSelect home"><span className="brand-mark"><i /><i /><i /></span><span>Flo<span>Select</span></span><small>by Paramet Solutions</small></a>
...
function DashboardMockup({ detailed = false }) {
  return <div className={`dashboard ${detailed ? 'dashboard-large' : ''}`}>
    <div className="dash-bar"><div className="dash-logo"><span className="brand-mark"><i /><i /><i /></span> FloSelect</div><div className="dash-actions"><span /><span /><b /></div></div>
...
function Footer() { return <footer><div className="container footer-inner"><a className="brand" href="#top"><span className="brand-mark"><i/><i/><i/></span><span>Flo<span>Select</span></span></a><p>FloSelect by Paramet Solutions</p><div className="footer-contact"><a href="mailto:sales@paramet.co.uk">sales@paramet.co.uk</a><a href="https://www.paramet.co.uk">www.paramet.co.uk</a><a className="linkedin" href="https://www.linkedin.com" aria-label="LinkedIn">in</a></div></div></footer> }
